...
CHECKPOINT_DIR=~/quic-efs/user/bowenjin/seq2seq/ckpt/$DOMAIN/sequential_retrieval/$ID_MODE

SEMANTIC_ID_MODEL_DIR=~/quic-efs/user/bowenjin/SemanticID/ckpt/$DOMAIN/GB/position2/load_soft_encdec_kmeans_code/contrastive/1e-3/0.7/quantization-512/final
