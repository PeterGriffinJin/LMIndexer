...
# DATA_DIR=/home/ec2-user/quic-efs/user/bowenjin/seq2seq/rec-data/$DOMAIN/sequential_retrieval/$ID_MODE

LOG_DIR=~/quic-efs/user/bowenjin/seq2seq/logs/$DOMAIN
CHECKPOINT_DIR=~/quic-efs/user/bowenjin/seq2seq/ckpt/$DOMAIN/sequential_retrieval/$ID_MODE/$BASE_EMBED_MODEL
...
rm -r /home/ec2-user/.cache/huggingface/datasets/json
