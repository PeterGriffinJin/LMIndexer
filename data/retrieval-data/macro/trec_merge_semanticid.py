...
assert args.mode in ['rqvae', 'tree', 'ours']

# read queries
with open(os.path.join(args.data_dir, 'TREC_DL_2019', args.mode, 'test.query.json')) as f:
...
# read queries binary
with open(os.path.join(args.data_dir, 'TREC_DL_2019', args.mode, 'test.query.binary.json')) as f:
    query_2019 = f.readlines()
    query_2019_num = len(query_2019)
